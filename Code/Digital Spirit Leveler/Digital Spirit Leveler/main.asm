...
;------------------------------------------Y-----------------------------------------
	...
	LDI R16,0X19;
	LDI R17,0X00
	LDS R30,DOWN_ROOT_02_L
	LDS R31,DOWN_ROOT_02_M
	LDS R27,DOWN_ROOT_02_H
	STS TEMP_L,R30
	STS TEMP_M,R31
	STS TEMP_H,R27
	CLR R27
	RCALL MULTI
	STS DOWN_ROOT_02_L,RES1;LOW BYTE
	STS DOWN_ROOT_02_M,RES2;MID BYTE
	STS DOWN_ROOT_02_H,RES3;HIGH BYTE
	RCALL CLEAR
	CLR RES1
	CLR RES2
	CLR RES3
	...
	LDI R16,0X50;
	LDI R17,0X00
	LDS R30,A0_SQURE_LOW
	LDS R31,A0_SQURE_MID
	RCALL MULTI
	STS A0_SQURE_LOW,RES1;LOW BYTE
	STS A0_SQURE_MID,RES2;MID BYTE
	STS A0_SQURE_HIGH,RES3;HIGH BYTE
	...
	RCALL CLEAR
	;-----(80XA0^2)/3------
	LDS R17,A0_SQURE_LOW
	LDS R18,A0_SQURE_MID
	LDS R20,A0_SQURE_HIGH
	LDI R26,0X03
	LDI R27,0X00
	LDI R28,0X00
	RCALL DIV
	STS A0_SQURE_LOW,R16;LOW BYTE
	STS A0_SQURE_MID,R23;MID BYTE
	STS A0_SQURE_HIGH,R29;HIGH BYTE
	;-----ADD----------------
	MOV R17,R16
	MOV R18,R23
	MOV R20,R29
	LDS R21,DOWN_ROOT_02_L
	LDS R22,DOWN_ROOT_02_M
	LDS R23,DOWN_ROOT_02_H
	LDI R24,0X00
	ADD R17,R21
	ADC R18,R22
	ADC R20,R23
...
;------------------------------------------Z-----------------------------------------
	...
	LDS R30,DOWN_ROOT_03_L
	LDS R31,DOWN_ROOT_03_M
	LDS R27,DOWN_ROOT_03_H
	...
	LDI R16,0X19;
	LDI R17,0X00
	LDS R30,C0_SQURE_LOW
	LDS R31,C0_SQURE_MID
	LDS R27,C0_SQURE_HIGH
	...
	LDS R31,DOWN_ROOT_03_M
	RCALL MULTI
	STS DOWN_ROOT_03_L,RES1;LOW BYTE
	STS DOWN_ROOT_03_M,RES2;MID BYTE
	STS DOWN_ROOT_03_H,RES3;HIGH BYTE
	CLR RES1
	CLR RES2
	CLR RES3
	CLR RES4
	RCALL CLEAR
	;-----(80XB0^2)/3------
	LDS R17,DOWN_ROOT_03_L
	LDS R18,DOWN_ROOT_03_M
	LDS R20,DOWN_ROOT_03_H
	LDI R26,0X03
	LDI R27,0X00
	LDI R28,0X00
	RCALL DIV
	STS DOWN_ROOT_03_L,R16;LOW BYTE
	STS DOWN_ROOT_03_M,R23;MID BYTE
	STS DOWN_ROOT_03_H,R29;HIGH BYTE
	;-----ADD----------------
	MOV R17,R16
	MOV R18,R23
	MOV R20,R29
	LDS R21,C0_SQURE_LOW
	LDS R22,C0_SQURE_MID
	LDS R23,C0_SQURE_HIGH
	LDI R24,0X00
	ADD R17,R21
	ADC R18,R22
	ADC R20,R23
